...
export const Carousel = () => {
    ...
    const images = [
        ...
        {
          image: img5,
          title: 'Experience comfort beyond compare, where every detail meets your needs',
        },
      ];
  ...
  return (
    ...
    <div className='img-carousel'>
        <div className="textOverlay">
          <p className="text-2xl font-bold img-text">{images[presentImg].title}</p>
        </div>
        <div className='buttonOverlay'>
          <div>
           <button onClick={previousImage} className="carousel-button"><i class="fa-solid fa-less-than"></i></button>
          </div>
          <div>
           <button onClick={nextImage} className="carousel-button"><i class="fa-solid fa-greater-than"></i></button>  
          </div>
        </div>
        <div className='img-description'>
            <img src={images[presentImg].image} alt="image-carousel" className={`carousel-img ${presentImg !== 0 ? 'fade-in' : ''}`} />
        </div>
